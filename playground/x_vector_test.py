...
xvector.print_n_comparisons(num_comparisons=5, model=model, recipe=[("Want to stay alive", 5), ("Okay with dying", -5)],
                    prompt='Some people think that death is scary and should be avoided. I think that', completion_length=85,
                    layer_num=15,  temperature=1, freq_penalty=1, top_p=.3, pad_method='tokens_right', random_seed=42)

# %%
# Is sentiment non-deterministic?
sentiment_pipeline = pipeline("sentiment-analysis")
for ii in range(10):
    print(sentiment_pipeline('I am sad'))